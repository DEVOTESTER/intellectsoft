! function(t) {
        ...
        (function(r, o) {
            ...
            ! function(r, o) {
                ...
                var ot = j.Reflect,
                    ...
                    ct = {
                        ...
                        ToInteger: function(t) {
                            var e = ct.ToNumber(t);
                            return Q(e) ? 0 : 0 !== e && U(e) ? (e > 0 ? 1 : -1) * F(L(e)) : e
                        },
                        ToLength: function(t) {
                ...
                var Et = function(t, e, n) {
                    ...
                    At = function(t, e, n) {
                        if (Ct(t, e, n), !ct.SameValue(t[e], n)) throw new TypeError("property is nonconfigurable")
                    },
                    kt = function(t, e, n, r) {
                ...
                if (String.fromCodePoint && 1 !== String.fromCodePoint.length) {
                    ...
                    et(String, "fromCodePoint", function(t) {
                        return ct.Call(It, this, arguments)
                    })
                }
                var Mt = {
                    ...
                    raw: function(t) {
                        var e = ct.ToObject(t, "bad callSite"),
                            ...
                            o = ct.ToLength(r);
                        if (o <= 0) return "";
                        for (var i, a, u, c, s = [], l = 0; l < o && (i = ct.ToString(l), u = ct.ToString(n[i]), A(s, u), !(l + 1 >= o));) a = l + 1 < arguments.length ? arguments[l + 1] : "", c = ct.ToString(a), A(s, c), l += 1;
                        return s.join("")
                    }
                };
                ...
                if (String.prototype.includes && !1 !== "a".includes("a", 1 / 0) && et(String.prototype, "includes", Ft.includes), String.prototype.startsWith && String.prototype.endsWith) {
                    var Lt = u(function() {
                            "/a/".startsWith(/a/)
                        }),
                        Dt = c(function() {
                    ...
                    Lt && Dt || (et(String.prototype, "startsWith", Ft.startsWith), et(String.prototype, "endsWith", Ft.endsWith))
                }
                nt && (c(function() {
                    var t = /a/;
                    return t[G.match] = !1, "/a/".startsWith(t)
                }) || et(String.prototype, "startsWith", Ft.startsWith), c(function() {
                    var t = /a/;
                    return t[G.match] = !1, "/a/".endsWith(t)
                }) || et(String.prototype, "endsWith", Ft.endsWith), c(function() {
                    var t = /a/;
                    return t[G.match] = !1, "/a/".includes(t)
                }) || et(String.prototype, "includes", Ft.includes)), m(String.prototype, Ft);
                var qt = ["\t\n\v\f\r   ᠎    ", "         　\u2028", "\u2029\ufeff"].join(""),
                    Nt = new RegExp("(^[" + qt + "]+)|([" + qt + "]+$)", "g"),
                    Rt = function() {
                        return ct.ToString(ct.RequireObjectCoercible(this)).replace(Nt, "")
                    },
                    $t = ["", "​", "￾"].join(""),
                    zt = new RegExp("[" + $t + "]", "g"),
                    Bt = /^[-+]0x[0-9a-f]+$/i,
                ...
                }, _t(Vt.prototype), _t(String.prototype, function() {
                    return new Vt(this)
                });
                var Gt = {
                    from: function(t) {
                        ...
                        if (void 0 !== (K(t) || ct.GetMethod(t, rt))) {
                            ...
                            var d;
                            for (c = 0; c < a; ++c) d = p[c], o && (d = void 0 === i ? e(d, c) : n(e, i, d, c)), At(u, c, d)
                        }
                        return u.length = a, u
                    },
                    of: function() {
                        for (var t = arguments.length, e = this, n = i(e) || !ct.IsCallable(e) ? new Array(t) : ct.Construct(e, [t]), r = 0; r < t; ++r) At(n, r, arguments[r]);
                        return n.length = t, n
                    }
                };
                m(Array, Gt), xt(Array), t = function(t, e) {
                ...
                }), _t(t.prototype), Array.of === Gt.of || function() {
                    var t = function(t) {
                        this.length = t
                    };
                    t.prototype = [];
                ...
                if (ue || ce || se) {
                    var le = Number,
                        ...
                        ge = function() {
                            var t = function(e) {
                                var n;
                                "string" == typeof(n = arguments.length > 0 ? tt.primitive(e) ? e : ve(e) : 0) && (n = ct.Call(Rt, n), de(n) ? n = parseInt(C(n, 2), 2) : he(n) ? n = parseInt(C(n, 2), 8) : (ye(n) || me(n)) && (n = NaN));
                                var r = this,
                                    o = c(function() {
                ...
                var we = Function.bind.call(Function.bind, Object.prototype.propertyIsEnumerable),
                    ...
                    Ee = function(t, e) {
                        var n, r = a(Object(e));
                        return ct.IsCallable(Object.getOwnPropertySymbols) && (n = h(Object.getOwnPropertySymbols(Object(e)), we(e))), d(_(r, n || []), je(e), t)
                    },
                    Te = {
                        assign: function(t, e) {
                ...
                if (Object.freeze && u(function() {
                    ...
                    et(Object, "freeze", function(t) {
                        return ct.TypeIsObject(t) ? Fe(t) : t
                    })
                }
                if (Object.isFrozen && u(function() {
                        Object.isFrozen("foo")
                    })) {
                    var Le = Object.isFrozen;
                ...
                if (Object.preventExtensions && u(function() {
                    ...
                    et(Object, "preventExtensions", function(t) {
                        return ct.TypeIsObject(t) ? De(t) : t
                    })
                }
                if (Object.isExtensible && u(function() {
                        Object.isExtensible("foo")
                    })) {
                    var qe = Object.isExtensible;
                    et(Object, "isExtensible", function(t) {
                        return !!ct.TypeIsObject(t) && qe(t)
                    })
                }
                ...
                var sn = {
                    acosh: function(t) {
                        var e = Number(t);
                        return Q(e) || t < 1 ? NaN : 1 === e ? 0 : e === 1 / 0 ? e : q(e / on + N(e + 1) * N(e - 1) / on) + 1
                    },
                    asinh: function t(e) {
                        var n = Number(e);
                        return 0 !== n && E(n) ? n < 0 ? -t(-n) : q(n + N(n * n + 1)) : n
                    },
                    atanh: function(t) {
                        var e = Number(t);
                        return Q(e) || e < -1 || e > 1 ? NaN : -1 === e ? -1 / 0 : 1 === e ? 1 / 0 : 0 === e ? e : .5 * q((1 + e) / (1 - e))
                    },
                    cbrt: function(t) {
                        var e = Number(t);
                        if (0 === e) return e;
                        var n, r = e < 0;
                        return r && (e = -e), e === 1 / 0 ? n = 1 / 0 : (n = D(q(e) / 3), n = (e / (n * n) + 2 * n) / 3), r ? -n : n
                    },
                    clz32: function(t) {
                        var e = Number(t),
                            n = ct.ToUint32(e);
                        return 0 === n ? 32 : cn ? ct.Call(cn, n) : 31 - F(q(n + .5) * an)
                    },
                    cosh: function(t) {
                        var e = Number(t);
                        return 0 === e ? 1 : Q(e) ? NaN : E(e) ? (e < 0 && (e = -e), e > 21 ? D(e) / 2 : (D(e) + D(-e)) / 2) : 1 / 0
                    },
                    expm1: function(t) {
                        var e = Number(t);
                        if (e === -1 / 0) return -1;
                        if (!E(e) || 0 === e) return e;
                        if (L(e) > .5) return D(e) - 1;
                    ...
                    log1p: function(t) {
                        var e = Number(t);
                        return e < -1 || Q(e) ? NaN : 0 === e || e === 1 / 0 ? e : -1 === e ? -1 / 0 : 1 + e - 1 == 0 ? e : e * (q(1 + e) / (1 + e - 1))
                    },
                    sign: Z,
                    sinh: function(t) {
                        var e = Number(t);
                        return E(e) && 0 !== e ? L(e) < 1 ? (Math.expm1(e) - Math.expm1(-e)) / 2 : (D(e - 1) - D(-e - 1)) * on / 2 : e
                    },
                    tanh: function(t) {
                        var e = Number(t);
                        return Q(e) || 0 === e ? e : e >= 20 ? 1 : e <= -20 ? -1 : (Math.expm1(e) - Math.expm1(-e)) / (D(e) + D(-e))
                    },
                    trunc: function(t) {
                        var e = Number(t);
                        return e < 0 ? -F(-e) : F(e)
                ...
                var yn = Math.imul; - 5 !== Math.imul(4294967295, 5) && (Math.imul = sn.imul, w.preserveToString(Math.imul, yn)), 2 !== Math.imul.length && et(Math, "imul", function(t, e) {
                ...
                if (j.Promise && (delete j.Promise.accept, delete j.Promise.defer, delete j.Promise.prototype.chain), "function" == typeof mn) {
                    ...
                    Oe(Promise, "all"), Oe(Promise, "race"), Oe(Promise, "resolve"), Oe(Promise, "reject"), xt(Promise)
                }
                var An = function(t) {
                ...
                if (l) {
                    var Mn = function(t, e) {
                            return e || kn ? ut(t) ? "^" + ct.ToString(t) : "string" == typeof t ? "$" + t : "number" == typeof t ? In ? t : "n" + t : "boolean" == typeof t ? "b" + t : null : null
                        },
                        Pn = function() {
                            ...
                            Map: function() {
                                ...
                                var a, u = function t() {
                                    ...
                                    var n = kt(this, t, a, {
                                        ...
                                        r = new e(null, null);
                                    return r.next = r.prev = r, n._head = r, arguments.length > 0 && Fn(t, n, arguments[0]), n
                                };
                            ...
                            Set: function() {
                                var t, e = function(t) {
                                    ...
                                    o = function e() {
                                        ...
                                        return arguments.length > 0 && Ln(e, n, arguments[0]), n
                                    };
                                t = o.prototype;
                                var i = function(t) {
                                        var e = t;
                                        ...
                                        if ("^undefined" !== e) {
                                            var n = e.charAt(0);
                                            return "$" === n ? C(e, 1) : "n" === n ? +C(e, 1) : "b" === n ? "btrue" === e : +e
                                        }
                                    },
                                    u = function(t) {
                                        if (!t["[[SetData]]"]) {
                                ...
                                }), y(o.prototype, "keys", o.prototype.values, !0), _t(o.prototype, o.prototype.values), o
                            }()
                        };
                    if (j.Map || j.Set) {
                        c(function() {
                            ...
                            if (!(this instanceof t)) throw new TypeError('Constructor Map requires "new"');
                            var e = new z;
                            return arguments.length > 0 && Fn(t, e, arguments[0]), delete e.constructor, Object.setPrototypeOf(e, j.Map.prototype), e
                        ...
                        var qn = new Map,
                            ...
                            Rn = qn.set(1, 2) === qn;
                        Nn && Rn || et(Map.prototype, "set", function(t, e) {
                        ...
                        0 === j.Map.length && !Yn && Qn || (j.Map = function t() {
                            if (!(this instanceof t)) throw new TypeError('Constructor Map requires "new"');
                            var e = new z;
                            return arguments.length > 0 && Fn(t, e, arguments[0]), delete e.constructor, Object.setPrototypeOf(e, t.prototype), e
                        ...
                        if (0 !== j.Set.length || Zn || !Jn) {
                            ...
                            j.Set = function t() {
                                ...
                                var e = new Xn;
                                return arguments.length > 0 && Ln(t, e, arguments[0]), delete e.constructor, Object.setPrototypeOf(e, t.prototype), e
                        ...
                        if (("function" != typeof j.Map.prototype.clear || 0 !== (new j.Set).size || 0 !== Kn.size || "function" != typeof j.Map.prototype.keys || "function" != typeof j.Set.prototype.keys || "function" != typeof j.Map.prototype.forEach || "function" != typeof j.Set.prototype.forEach || s(j.Map) || s(j.Set) || "function" != typeof Kn.keys().next || tr || !Gn) && m(j, {
                                Map: Dn.Map,
                                Set: Dn.Set
                            }, !0), j.Set.prototype.keys !== j.Set.prototype.values && y(j.Set.prototype, "keys", j.Set.prototype.values, !0), _t(Object.getPrototypeOf((new j.Map).keys())), _t(Object.getPrototypeOf((new j.Set).keys())), f && "has" !== j.Set.prototype.has.name) {
                ...
                Object.getOwnPropertyNames && Object.assign(rr, {
                    ownKeys: function(t) {
                        ...
                        return ct.IsCallable(Object.getOwnPropertySymbols) && k(e, Object.getOwnPropertySymbols(t)), e
                    }
                });
                var or = function(t) {
                    return !u(t)
                ...
                if (!p(t, n.successClass) && (e || n.loadInvisible || t.offsetWidth > 0 && t.offsetHeight > 0)) {
                    ...
                    if (r) {
                        ...
                        if (h || void 0 === t.src) {
                            var O = new Image,
                                j = function() {
                                    n.error && n.error(t, "invalid"), d(t, n.errorClass), m(O, "error", j), m(O, "load", x)
                                },
                                x = function() {
                                    h ? b || u(t, c, l) : t.style.backgroundImage = 'url("' + c + '")', i(t, n), m(O, "load", x), m(O, "error", j)
                                };
                            b && (O = t, g(v.getElementsByTagName("source"), function(t) {
                                a(t, T, n.srcset)
                            })), y(O, "error", j), y(O, "load", x), u(O, c, l)
                        } else t.src = c, i(t, n)
    ...
    95: function(t, e, n) {
        ...
        $(function() {
            function t() {
                $(window).scrollTop() > n.offset().top - 10 ? (e.css("top", "90px"), e.addClass("fixed-form"), e.removeClass("stop-form")) : (e.css("top", "auto"), e.removeClass("fixed-form"), e.removeClass("stop-form")), $(window).scrollTop() > r.offset().top + 90 && (e.css("top", r.offset().top + 180 - o + "px"), e.removeClass("fixed-form"), e.addClass("stop-form"))
            }
            var e = $("#pined-form-main"),
                n = $("#trigger-block"),
                r = $(".e-book-last-block.about-webinar"),
                o = $(".hero").innerHeight(),
                i = window.innerWidth;
            n.length && window.innerWidth >= 1024 && (t(), $(window).on("scroll", t)), $(window).on("resize", function() {
                i !== window.innerWidth && window.innerWidth >= 767 && location.reload()
            })
        }), $(function() {
            var t = {
                    offset: -25,
                ...
                e = $(".smooth-scroll");
            document.querySelector("#pined-form-main") && e.on("click", function(e) {
                e.preventDefault(), (0, o.default)(document.querySelector("#pined-form-main"), t)
            })
        }), $(function() {
            var t = $(".container.markdown"),
                e = $('<div class="wrap-ul"></div>'),
                n = t.find("h2");
            if (t.length > 0) {
                var r = t.find("ul");
                r.length > 0 && (n.after(e), e.prepend(r))
            }
        })
    },
    96: function(t, e, n) {
        ...
        var p = function(t) {
            ...
            d = function(t) {
                return t ? t.style.display = "block" : null
            };
        $("form").each(function() {
                $(this).validate({
                    ...
                    submitHandler: function(t, e) {
                        ...
                        n.append("handler_id", t.dataset.handler), c && c.classList.add("js-show"), "form-contacts" === t.getAttribute("id") && (p(s), a() && localStorage.setItem(u, JSON.stringify({
                            ...
                            e.data.status ? (p(t), d(i)) : Object.keys(e.data).length >= 1 ? Object.keys(e.data).map(function(t) {
                                var e = t.split("-")[1],
                                    n = document.querySelector("[name=" + e + "]"),
                            ...
                            d(o), d(s), c && c.classList.remove("js-show"), console.log(t)
                        })
                    }
                })
            }),
                ...
                var e = {
                        ...
                        on: {
                            ...
                            slideChangeTransitionEnd: function() {
                                for (var t = this, e = t.el.querySelectorAll(".caption"), n = 0; n < e.length; ++n) e[n].classList.remove("show");
                                t.slides[t.activeIndex].querySelector(".caption").classList.add("show")
                            },
                            progress: function() {
                                for (var t = this, e = 0; e < t.slides.length; e++) {
                                    var n = t.slides[e].progress,
                                        r = .5 * t.width,
                                        o = n * r;
                                    t.slides[e].querySelector(".slide-wrapper").style.transform = "translate3d(" + o + "px, 0, 0)"
                                }
                            },
                            touchStart: function() {
                            ...
                            setTransition: function(t) {
                                for (var e = this, n = 0; n < e.slides.length; n++) e.slides[n].style.transition = t + "ms", e.slides[n].querySelector(".slide-wrapper").style.transition = t + "ms"
                            }
                        }
                    },
                    n = new Swiper(".main-slider", e),
                    r = {
                        loop: !0,
                        loopAdditionalSlides: 12,
                        speed: 1e3,
                        ...
                        on: {
                            ...
                            setTransition: function(t) {
                                for (var e = this, n = 0; n < e.slides.length; n++) e.slides[n].style.transition = t + "ms", e.slides[n].querySelector(".logo-nav").style.transition = t + "ms"
                            }
                        },
                        breakpoints: {
                            480: {
